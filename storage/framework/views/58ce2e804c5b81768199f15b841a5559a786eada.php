<div class='btn-group'>
    <!--<a href="<?php echo e(route('nusers.show', $id)); ?>" class='btn btn-default btn-xs'>
        <i class="glyphicon glyphicon-eye-open"></i>
    </a>-->
    <a data-remote="<?php echo e($id); ?>" id="addExtension" data-toggle="modal" data-target="#inquiry_view" class='btn btn-default btn-xs'>
