<?php $__env->startSection('content-header'); ?>
    ...
    <ol class="breadcrumb">
	    <li><a href="<?php echo e(URL::asset('/')); ?>cms"><i class="fa fa-home"></i> Dashboard</a></li>
    </ol>
...
<script type="text/javascript">		
	...
	{
		var url = "<?php echo e(url('/cms/dstats/')); ?>"
		$.ajax({
			url: url,
			type: 'GET',
			dataType: 'json',
			data: {method: '_POST', "_token": "<?php echo e(csrf_token()); ?>", submit: true},
