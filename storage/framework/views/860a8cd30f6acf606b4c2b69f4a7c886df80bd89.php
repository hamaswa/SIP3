...
<div class="form-group col-sm-6">
    ...
    <?php else: ?>
        <?php echo Form::select('extension', $data['extensions'], null, array('class'=>'form-control','required','multiple' => 'multiple','name'=>'extension[]'));; ?>
...
<div class="form-group col-sm-6">
    ...
    <?php else: ?>
        <?php echo Form::select('queue', $data['queue'], null, array('class'=>'form-control','required','multiple' => 'multiple','name'=>'queue[]'));; ?>
