            ...
            <div class="box-body">
                <form action="<?php echo e(route("permissions.store")); ?>" method="post">
                    ...
                    <table class="table table-responsive table-bordered table-dark">
                        <?php if(isset($permissions['sub_users'])): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                    <?php if(isset($permissions['user_add'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($permissions['user_edit'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($permissions['user_delete'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($permissions['user_permission'])): ?>
                        ...
                        <?php if(isset($permissions['dashboard_view'])): ?>
                        <tr>
                        ...
                        <?php endif; ?>
                        <?php if(isset($permissions['view_combined'])): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(isset($permissions['download_combined'])): ?>
                        ...
                        <?php endif; ?>
                        <?php if(isset($permissions['view_distribution'])): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(isset($permissions['download_distribution'])): ?>
                        ...
                        <?php endif; ?>
                        <?php if(isset($permissions['view_outgoing'])): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(isset($permissions['download_outgoing'])): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(isset($permissions['download_incomeing'])): ?>
                        ...
                        <?php endif; ?>
                        <?php if(isset($permissions['view_queue_status'])): ?>
                        ...
                        <?php if(isset($permissions['view_callback'])): ?>
